...
namespace TiltControl
{
    public partial class MainPage : ContentPage
    {
        ...
        //      -removing 'const' because of new feature
        ...
        //      Updating disc size label and disc size on screen when sensor is poeweed off
        private void UpdateDiscUI()
        {

            SizeLabel.Text = $"{DiscSize:F0}";
        ...
        //      Increasing disc size and putting him in limits [20, 200]
        private void SizeUp(object sender, EventArgs e)
        {
            DiscSize += 5;
            DiscSize = Math.Clamp(DiscSize, 20, 200);

            UpdateDiscUI();
        }
        //      Decreasing disc size and putting him in limits [20, 200]
...
//      Ensuring sensor is turned off when page is disappearing
        protected override void OnDisappearing()
        {
//          Call the base class method
            base.OnDisappearing();

//          If the sensor is currently toggled on, toggle it off
            if (IsToggled)
            {
                ToggleSensor(this, EventArgs.Empty);
